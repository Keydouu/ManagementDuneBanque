...
int main()
{
    int a,B,i,J,u,w,y,z,CHOICE,CHOICE2,CHOICE3,CHOICE4; // ADD DATE LATER
    int *AdresseCHOICE,*AdresseCHOICE2,*AdresseCHOICE3,*AdresseCHOICE4,*Monpointeur;
    ...
    srand(time(0));
    AdresseCHOICE=&CHOICE;AdresseCHOICE2=&CHOICE2;AdresseCHOICE3=&CHOICE3;AdresseCHOICE4=&CHOICE4;Monpointeur=&a;
    ...
    if(x==0)
    {
        ...
        printf("\n\n      Se  Deconnecter      \n\n");
        MENU(a);
        choisir(Monpointeur,1,4,AdresseCHOICE);
        }
        a=1;
        ...
        printf("\n\n        Menu General       \n\n");
        MENU(a);
        choisir(Monpointeur,1,5,AdresseCHOICE2);
        }
        a=1;
                ...
                for(i=0;r<12;r++)
    {
        ...
        else if((inpt=='f')||(inpt=='F')||(inpt==0x50)||(inpt==13))
            {
                if(a<4)
                    {a++;i=0;
                if(a==4)
    ...
    CHOICE=1;CHOICE2=1;CHOICE3=1;w=1;
        ...
        printf("\n\n        Retour        \n\n");
        MENU(a);
        choisir(Monpointeur,1,3,AdresseCHOICE3);
        }a=1;
        switch(CHOICE3)
        {
        case 1: //Recherche par nom
            {
                ...
                else if(inpt==27)// 9 est pour retourner au menu general
                {
        ...
        case 2: //Recherche par id (Perfect)
            {
                ...
                inpt=getch();
                system("cls");
                if(inpt==27) //esc est pour quitter
                    {J=9;system("cls");}
                else
                    {
                        if(J)
        ...
        printf("\n\n       Menu General       \n\n");
        MENU(a);
        choisir(Monpointeur,1,4,AdresseCHOICE2);
        }a=1;
        ...
        printf("\n\n        Menu General       \n\n");
        MENU(a);
        choisir(Monpointeur,1,3,AdresseCHOICE2);
        }a=1;
